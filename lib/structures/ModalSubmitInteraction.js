...
* @prop {Message?} message The message the interaction was created in
*/
class ModalSubmitInteraction extends Interaction {
    constructor(data, client) {
        ...
        if(data.message !== undefined && this.channel.hasOwnProperty("messages")) {
            this.message = this.channel.messages.update(data.message, this._client);
        }
